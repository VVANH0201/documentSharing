function load(){
    ...
    $.ajax({
    type: "GET",
    url: `http://localhost:8001/api/v1/documents/getbytype?id=${type_id}&limit=10&vt=new`,
...
function load1(){
    ...
    $.ajax({
    type: "GET",
    url: `http://localhost:8001/api/v1/documents/getbytype?id=${type_id}&limit=10&vt=view`,
    ...
    success: function (response) {
       ...
       num_ip.setAttribute("value", num);
        for (const document of response.data) {
            ...
            $('#list_document').append(str);
            //$('.text_more').append("Xem them");
            text_more1.style.display = 'block';
        }
        for (const document of response.data) {
              displayFirstPage(document.link, "pdfImage1"+document.id);
            }    
...
const type_id = document.getElementById("type_id").value;
    ...
    $.ajax({
    type: "GET",
    url: `http://localhost:8001/api/v1/documents/getbytype?id=${type_id}&limit=${num_ip_new}&vt=new`,
...
const type_id = document.getElementById("type_id").value;
    ...
    $.ajax({
    type: "GET",
    url: `http://localhost:8001/api/v1/documents/getbytype?id=${type_id}&limit=${num_ip_new}&vt=view`,
